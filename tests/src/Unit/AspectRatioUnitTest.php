...
namespace Drupal\Tests\css_aspect_ratio\Unit;
...
/**
 * @coversDefaultClass \Drupal\css_aspect_ratio\AspectRatioManager
 * @group block
 */
class AspectRatioUnitTest extends UnitTestCase {
